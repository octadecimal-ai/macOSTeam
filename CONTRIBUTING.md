...
```bash
.llm/hooks/watchdog_report.sh minor "opis naruszenia"
.llm/hooks/watchdog_report.sh major "opis naruszenia"
.llm/hooks/watchdog_report.sh critical "opis naruszenia"
```
...
```
agent: LLM Sonnet 4.6 <noreply@llm-provider.com>
```
