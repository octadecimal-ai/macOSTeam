...
```bash
source /workspace/Lab/scripts/bws_helper.sh
...
```bash
bash /workspace/Lab/scripts/rotate_bws_token.sh
```
...
- Helper: `/workspace/Lab/scripts/bws_helper.sh`
- Watcher: `/workspace/Lab/scripts/watch_macOSTeam.sh`
- Rotacja: `/workspace/Lab/scripts/rotate_bws_token.sh`
