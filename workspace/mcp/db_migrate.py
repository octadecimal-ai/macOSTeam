...
def seed_pricing(conn: sqlite3.Connection, today: str, now: str) -> None:
    """Cennik modeli Claude — stan na 2026-05-08. Źródło: anthropic.com/pricing."""
    pricing = [
        # (model_id, model_name, input, output, cache_write, cache_read)
        ("claude-opus-4-7",           "Claude Opus 4.7",  15.00, 75.00, 18.75, 1.50),
        ("claude-sonnet-4-6",         "Claude Sonnet 4.6",  3.00, 15.00,  3.75, 0.30),
        ("claude-haiku-4-5-20251001", "Claude Haiku 4.5",   0.80,  4.00,  1.00, 0.08),
    ]
    for row in pricing:
        conn.execute(
            """INSERT OR IGNORE INTO model_pricing
               ...
               VALUES (?,?,?,?,?,?,?,?,?)""",
            (*row, today, "anthropic.com/pricing", now),
        )
